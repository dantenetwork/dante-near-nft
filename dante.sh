...
mint()
{
    near call nft.georgecross.testnet nft_mint '{"token_id":"1","receiver_id":"georgecross.testnet","token_metadata":{"title":"World Tree NFT","description":"To celebrate the epic upgrade of Dante Network, this NFT will be claimed by Dante active community members. This is also Dante’s initial NFT issuance. ","media":"https://ipfs.io/ipfs/QmdUySjLw9AWtgirvevLVKsn2JPZK3vfWvhX5c81s2jCM3?filename=1.png"}}' --accountId georgecross.testnet --deposit 1
}
